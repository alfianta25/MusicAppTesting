...
import 'package:music_player_app/feature/musicplayerhome/model/songs.dart';
...
class ItuneServices {
  ...
  ItuneServices({this.client});

  Future<List<Songs>> getSearchResults(String searchTerm) async {
    ...
    try {
      http.Response res =
          this.client == null ? await http.get(uri) : await client.get(uri);
      ...
      if (res.statusCode == 200) {
        ...
        List<Songs> songs = Songs().fromJsonList(out['results']);
